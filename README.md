...
### Version
[`0.1.0`](https://bitbucket.org/arcticicestudio/icecore-strman/downloads)  
...
### Contribution
Please report issues/bugs, suggestions for improvements and feature requests to the [issuetracker](https://bitbucket.org/arcticicestudio/icecore-strman/issues) or via [email](mailto:bugs@arcticicestudio.com)

### Author
The [IceCore](https://bitbucket.org/arcticicestudio/icecore) engine project and [IceCore - String Manipulation](https://bitbucket.org/arcticicestudio/icecore-strman) module is developed and authored by [Arctic Ice Studio](http://arcticicestudio.com).
...
### References
  - [IceCore](https://bitbucket.org/arcticicestudio/icecore)
